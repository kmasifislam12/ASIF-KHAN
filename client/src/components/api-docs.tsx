...
public class ROMEL XITERS
{
    ...
    public ROMEL XITERS(string apiKey, string appVersion = "1.0.0", 
...
{
    var auth = new ROMEL XITERS("your-api-key-here");
...
# Usage Examples:
auth = ROMEL XITERS("your-api-key-here")
...
class ROMEL XITERS {
    ...
    async login(username, password, includeHwid = true) {
        ...
        if (includeHwid) {
            data.hwid = ROMEL XITERS.getHardwareId();
        }
...
const auth = new ROMEL XITERS('your-api-key-here');
...
public:
    ROMEL XITERS(const std::string& key, const std::string& version = "1.0.0", 
...
// Usage Example:
int main() {
    ROMEL XITERS auth("your-api-key-here");
