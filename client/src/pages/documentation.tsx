                  ...
                  <div className="bg-muted/50 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button 
                        variant="ghost" 
                        size="sm"
                        onClick={() => copyToClipboard(`class ROMEL XITERS {
...
// Usage example
const auth = new ROMEL XITERS('your_api_key_here');
...
# Usage example
auth = ROMEL XITERS('your_api_key_here')
    ...
    print(f"Registration failed: {result.get('message')}")`}
              ...
              <TabsContent value="csharp">
                <div className="space-y-4">
                  ...
                  <div className="bg-muted/50 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium">Complete ROMEL XITERS Class with HWID Support</span>
                      <Button 
                        variant="ghost" 
                        size="sm"
...
public class ROMEL XITERS
{
    ...
    public ROMEL XITERS(string apiKey, string appVersion = "1.0.0", string baseUrl = "${window.location.origin}/api/v1")
    {
        _apiKey = apiKey;
        _baseUrl = baseUrl;
...
public partial class LoginForm : Form
{
    ...
    {
        InitializeComponent();
        _auth = new ROMEL XITERS(API_KEY, APP_VERSION);
    }
    ...
    private async void LoginForm_Load(object sender, EventArgs e)
    {
        ...
        lblHwid.Text = "HWID: " + ROMEL XITERS.GetHardwareId();
    }
}
...
// Usage example
$auth = new ROMEL XITERS('your_api_key_here');
                  ...
                  <div className="bg-muted/50 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Button 
                        variant="ghost" 
                        size="sm"
                        onClick={() => copyToClipboard(`// HWID Generation Method (Already included in ROMEL XITERS class)
public static string GetHardwareId()
{
    try
    {
...
if (!result.Success && result.Message.Contains("HWID"))
{
    MessageBox.Show("This account is locked to a different computer!", "Hardware Mismatch", 
                   MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    ...
                    <pre className="text-sm overflow-x-auto">
{`// HWID Generation Method (Already included in ROMEL XITERS class)
public static string GetHardwareId()
{
    try
    {
...
// Initialize ROMEL XITERS with version
ROMEL XITERS _auth = new ROMEL XITERS(API_KEY, APP_VERSION);
