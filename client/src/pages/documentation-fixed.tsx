...
public class ROMEL XITERS
{
    ...
    public ROMEL XITERS(string apiKey = "${apiKey}", string appVersion = "${appVersion}", string baseUrl = "${baseUrl}/api/v1")
    {
        _apiKey = apiKey;
        _baseUrl = baseUrl;
...
var auth = new ROMEL XITERS("${apiKey}", "${appVersion}");
var result = await auth.LoginAsync("username", "password");
            ...
            <div className="space-y-6">
              <div className="bg-muted/50 rounded-lg p-4 mb-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium">Complete ROMEL XITERS Class</span>
                  <Button 
                    variant="ghost" 
                    size="sm"
