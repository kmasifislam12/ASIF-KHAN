...
public partial class LoginForm : Form
{
    ...
    public LoginForm()
    {
        ...
        _auth = new ROMEL XITERS("your-api-key-here", "1.0.0", "https://your-replit-url.replit.dev/api/v1");
    }

    private void InitializeComponent()
    {
        this.Text = "ROMEL XITERS Login";
...
public partial class RegisterForm : Form
{
    ...
    public RegisterForm(ROMEL XITERS auth)
    {
        _auth = auth;
        InitializeComponent();
    }
